...
"use strict";
module.exports = __webpack_require__.p + "img/chat.982324fc.svg";
...
const Themeable = external_commonjs_vue_commonjs2_vue_root_Vue_default().extend().extend({
  name: 'themeable',
  provide() {
    return {
...
/* harmony default export */ var VApp = (mixins(themeable).extend({
  name: 'v-app',
  props: {
    dark: {
      type: Boolean,
...
;// CONCATENATED MODULE: ./node_modules/vuetify/src/components/VAppBar/VAppBar.sass
// extracted by mini-css-extract-plugin
...
class Theme extends Service {
  ...
  initTheme(root) {
    ...
    root.$once('hook:created', () => {
      const obs = external_commonjs_vue_commonjs2_vue_root_Vue_default().observable({
        themes: this.themes
      });
...
/* harmony default export */ var elevatable = (external_commonjs_vue_commonjs2_vue_root_Vue_default().extend({
  name: 'elevatable',
  props: {
...
/* harmony default export */ var measurable = (external_commonjs_vue_commonjs2_vue_root_Vue_default().extend({
  name: 'measurable',
  props: {
...
/* harmony default export */ var roundable = (external_commonjs_vue_commonjs2_vue_root_Vue_default().extend({
  name: 'roundable',
  props: {
...
/* harmony default export */ var VImg = (mixins(components_VResponsive, themeable).extend({
  name: 'v-img',
  directives: {
    intersect: intersect
  },
...
/* harmony default export */ var VToolbar = (VSheet.extend({
  name: 'v-toolbar',
  props: {
    absolute: Boolean,
    bottom: Boolean,
...
/* harmony default export */ var scrollable = (external_commonjs_vue_commonjs2_vue_root_Vue_default().extend({
  name: 'scrollable',
  directives: {
    Scroll: Scroll
  },
...
/* harmony default export */ var ssr_bootable = (external_commonjs_vue_commonjs2_vue_root_Vue_default().extend({
  name: 'ssr-bootable',
  data: () => ({
    isBooted: false
  }),
...
const baseMixins = mixins(VToolbar, scrollable, ssr_bootable, toggleable, applicationable('top', ['clippedLeft', 'clippedRight', 'computedHeight', 'invertedScroll', 'isExtended', 'isProminent', 'value']));
/* @vue/component */

/* harmony default export */ var VAppBar = (baseMixins.extend({
  name: 'v-app-bar',
  directives: {
...
/* harmony default export */ var routable = (external_commonjs_vue_commonjs2_vue_root_Vue_default().extend({
  name: 'routable',
  directives: {
    Ripple: ripple
  },
...
/* harmony default export */ var VBtn = (VBtn_baseMixins.extend().extend({
  name: 'v-btn',
  props: {
    activeClass: {
      type: String,
...
/* harmony default export */ var VAppBarNavIcon = (external_commonjs_vue_commonjs2_vue_root_Vue_default().extend({
  ...
  render(h, {
    ...
    return h(VBtn, d, defaultSlot || [h(components_VIcon, '$menu')]);
  }
}));
...
/* harmony default export */ var VAvatar = (mixins(colorable, measurable, roundable).extend({
  name: 'v-avatar',
  props: {
    left: Boolean,
    right: Boolean,
...
/* harmony default export */ var VProgressLinear = (VProgressLinear_baseMixins.extend({
...
/* harmony default export */ var loadable = (external_commonjs_vue_commonjs2_vue_root_Vue_default().extend().extend({
  name: 'loadable',
  props: {
    loading: {
      type: [Boolean, String],
...
/* harmony default export */ var VCard = (mixins(loadable, routable, components_VSheet).extend({
  name: 'v-card',
  props: {
    flat: Boolean,
    hover: Boolean,
...
const cache = new Map();
/* harmony default export */ var VCol = (external_commonjs_vue_commonjs2_vue_root_Vue_default().extend({
  name: 'v-col',
  functional: true,
  props: {
    cols: {
...
;// CONCATENATED MODULE: ./node_modules/vuetify/src/components/VGrid/_grid.sass
// extracted by mini-css-extract-plugin
...
/* harmony default export */ var VContainer = (VGrid('container').extend({
  name: 'v-container',
  functional: true,
  props: {
    id: String,
...
;// CONCATENATED MODULE: ./node_modules/vuetify/src/components/VFooter/VFooter.sass
// extracted by mini-css-extract-plugin
...
/* harmony default export */ var VFooter = (mixins(VSheet, applicationable('footer', ['height', 'inset']), ssr_bootable).extend({
  name: 'v-footer',
  props: {
    height: {
      default: 'auto',
...
/* harmony default export */ var VList = (VSheet.extend().extend({
  name: 'v-list',
  provide() {
    return {
      isInList: true,
...
/* harmony default export */ var VListItem = (VListItem_baseMixins.extend().extend({
  name: 'v-list-item',
  directives: {
    Ripple: ripple
  },
...
/* harmony default export */ var VListItemAction = (external_commonjs_vue_commonjs2_vue_root_Vue_default().extend({
...
/* harmony default export */ var VListItemIcon = (external_commonjs_vue_commonjs2_vue_root_Vue_default().extend({
...
/* harmony default export */ var VListGroup = (VListGroup_baseMixins.extend().extend({
  name: 'v-list-group',
  directives: {
    ripple: ripple
  },
...
/* harmony default export */ var VListItemGroup = (mixins(BaseItemGroup, colorable).extend({
...
/* harmony default export */ var VMain = (ssr_bootable.extend({
  name: 'v-main',
  props: {
    tag: {
      type: String,
...
;// CONCATENATED MODULE: ./node_modules/vuetify/src/components/VMenu/VMenu.sass
// extracted by mini-css-extract-plugin
...
/* harmony default export */ var delayable = (external_commonjs_vue_commonjs2_vue_root_Vue_default().extend().extend({
  name: 'delayable',
  props: {
    openDelay: {
      type: [Number, String],
...
/* harmony default export */ var stackable = (external_commonjs_vue_commonjs2_vue_root_Vue_default().extend().extend({
  name: 'stackable',
  data() {
    return {
      stackElement: null,
...
const menuable_baseMixins = mixins(stackable, factory(['top', 'right', 'bottom', 'left', 'absolute']), activatable, detachable);
/* @vue/component */
...
/* harmony default export */ var returnable = (external_commonjs_vue_commonjs2_vue_root_Vue_default().extend({
  name: 'returnable',
  props: {
    returnValue: null
  },
...
/* harmony default export */ var VMenu = (VMenu_baseMixins.extend({
  name: 'v-menu',
  directives: {
...
;// CONCATENATED MODULE: ./node_modules/vuetify/src/components/VNavigationDrawer/VNavigationDrawer.sass
// extracted by mini-css-extract-plugin
...
/* harmony default export */ var mobile = (external_commonjs_vue_commonjs2_vue_root_Vue_default().extend({
  name: 'mobile',
  props: {
    mobileBreakpoint: {
      type: [Number, String],
...
;// CONCATENATED MODULE: ./node_modules/vuetify/src/components/VOverlay/VOverlay.sass
// extracted by mini-css-extract-plugin
...
/* harmony default export */ var VOverlay = (mixins(colorable, themeable, toggleable).extend({
  name: 'v-overlay',
  props: {
    absolute: Boolean,
    color: {
...
/* harmony default export */ var components_VOverlay = (VOverlay);
...
/* harmony default export */ var overlayable = (external_commonjs_vue_commonjs2_vue_root_Vue_default().extend().extend({
  name: 'overlayable',
  props: {
    hideOverlay: Boolean,
    overlayColor: String,
...
/* harmony default export */ var VNavigationDrawer = (VNavigationDrawer_baseMixins.extend({
...
/* harmony default export */ var VRow = (external_commonjs_vue_commonjs2_vue_root_Vue_default().extend({
  name: 'v-row',
  functional: true,
  props: {
    tag: {
...
;// CONCATENATED MODULE: ./node_modules/vuetify/src/components/VTextField/VTextField.sass
// extracted by mini-css-extract-plugin
...
/* harmony default export */ var VTextField = (VTextField_baseMixins.extend().extend({
  name: 'v-text-field',
  directives: {
    resize: resize,
    ripple: ripple
...
var render = function render() {
  ...
  return _c('div', {
  ...
  })], 1), _c(VSpacer), _c(VBtn, {
    attrs: {
      "icon": "",
      "color": _vm.NavItemColor
    }
  }, [_c(VIcon_VIcon, [_vm._v("mdi-heart")])], 1), _c(VBtn, {
    attrs: {
      "icon": "",
      "color": _vm.NavItemColor
    }
  }, [_c(VIcon_VIcon, [_vm._v("mdi-magnify")])], 1), _c(VMenu, {
    attrs: {
      "left": "",
      "bottom": ""
    },
    scopedSlots: _vm._u([{
      ...
      fn: function ({
        ...
        }, 'v-btn', attrs, false), on), [_c(VIcon_VIcon, [_vm._v("mdi-dots-vertical")])], 1)];
      }
    }])
  }, [_c(VList, _vm._l(5, function (n) {
    return _c(VListItem, {
      key: n,
      on: {
        "click": () => {}
      }
    }, [_c(VListItemTitle, [_vm._v("Option " + _vm._s(n))])], 1);
  }), 1)], 1)], 1), _c(VAppBar, {
    attrs: {
      "flat": "",
      "color": _vm.color
    ...
    return _c(VListItem, {
      ...
      on: {
        "click": function ($event) {
          return _vm.selectedUser(item);
        }
      }
    }, [_c(VListItemAvatar, [_c(VImg, {
      attrs: {
        "src": item.avatar
      }
    })], 1), _c(VListItemContent, [_c(VListItemTitle, {
      domProps: {
  ...
  }), _vm.selectedUserdata.name ? _c(VAvatar, {
    on: {
      "click": function ($event) {
        $event.stopPropagation();
        _vm.drawerRight = true;
      }
    }
  }, [_c(VImg, {
    attrs: {
      "src": _vm.selectedUserdata.avatar
    }
  })], 1) : _vm._e(), _vm.selectedUserdata.name ? _c(VListItemContent, {
    staticClass: "ms-3"
  }, [_c(VListItemTitle, {
    class: `${_vm.NavItemColor}--text`,
    attrs: {
      "color": _vm.NavItemColor
    }
  }, [_vm._v(_vm._s(_vm.selectedUserdata.name))]), _c(VListItemSubtitle, {
    staticClass: "caption",
    class: `${_vm.NavItemColor}--text`
  }, [_vm._v(" Online ")])], 1) : _vm._e(), _c(VSpacer), _c(VBtn, {
    attrs: {
      "icon": "",
      "color": _vm.NavItemColor
    }
  ...
  }, [_c(VListItemAction, [_c(VIcon_VIcon, {
    attrs: {
      "color": _vm.NavItemColor
    }
  }, [_vm._v("mdi-exit-to-app")])], 1), _c(VListItemContent, [_c('h2', {
    class: `${_vm.NavItemColor}--text`
  }, [_vm._v("Profile")])])], 1)], 1)], 1), _c(VCard, {
    ...
    class: `${_vm.NavItemColor}--text`
  }, [_vm._v("Contact Info")])])], 1)], 1)], 1)], 1), _c(VMain, [!_vm.selectedUserdata.name ? _c(VContainer, [_c(VRow, {
    attrs: {
      "justify": "center",
      "align": "center"
    }
    ...
    attrs: {
      "contain": "",
      "src": __webpack_require__(3058)
    }
  })], 1)], 1), _c(VCol, {
    staticClass: "shrink"
  }, [_c('h2', {
    staticClass: "text-center"
  }, [_vm._v("Let's Say Hi...!")]), _c('p', {
    staticClass: "text-center"
  }, [_vm._v(" Easy to start a conversation just select the user who you intened to have a chat. ")])])], 1) : _vm._e(), _vm.selectedUserdata.name ? _c(VContainer, _vm._l(_vm.messages, function (message) {
    return _c('div', {
      key: message
    }, [message.from_message ? _c(VCard, {
      ...
      staticClass: "pa-2 ma-1 rounded-tr-xl rounded-bl-xl",
      attrs: {
        "outlned": "",
        "elevation": "2",
        "tile": "",
    ...
    }, [_vm._v(" " + _vm._s(message.txtMsg) + " ")])], 1) : _c(VCard, {
      ...
      staticClass: "pa-2 ma-1 white--text rounded-tl-xl rounded-br-xl",
      attrs: {
        "color": _vm.color,
        "outlined": "",
        "elevation": "2",
      ...
      staticClass: "p-0 m-0"
    }, [_vm._v(_vm._s(message.txtMsg))]), message.view_msg ? _c(VIcon_VIcon, {
      staticClass: "d-flex justify-end",
      attrs: {
        "color": "success"
      }
    }, [_vm._v("mdi-check-all")]) : _vm._e()], 1)], 1)], 1);
  }), 0) : _vm._e()], 1), _vm.selectedUserdata.name ? _c(VFooter, {
  ...
  }, [_c(VIcon_VIcon, [_vm._v("mdi-send")])], 1)], 1)], 1)], 1)], 1) : _vm._e()], 1)], 1)], 1);
};
var staticRenderFns = [];

;// CONCATENATED MODULE: ./src/components/CustomChat.vue?vue&type=template&id=2a5bc6ac&

;// CONCATENATED MODULE: ./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib/index.js??clonedRuleSet-40.use[1]!./node_modules/@vue/vue-loader-v15/lib/index.js??vue-loader-options!./src/components/CustomChat.vue?vue&type=script&lang=js&

/* harmony default export */ var CustomChatvue_type_script_lang_js_ = ({
  data: () => ({
    drawer: null,
    name: "Harley David",
...
;// CONCATENATED MODULE: ./src/components/CustomChat.vue?vue&type=script&lang=js&
 /* harmony default export */ var components_CustomChatvue_type_script_lang_js_ = (CustomChatvue_type_script_lang_js_); 
;// CONCATENATED MODULE: ./node_modules/mini-css-extract-plugin/dist/loader.js??clonedRuleSet-12.use[0]!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-12.use[1]!./node_modules/@vue/vue-loader-v15/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-12.use[2]!./node_modules/@vue/vue-loader-v15/lib/index.js??vue-loader-options!./src/components/CustomChat.vue?vue&type=style&index=0&id=2a5bc6ac&prod&lang=css&
// extracted by mini-css-extract-plugin

;// CONCATENATED MODULE: ./src/components/CustomChat.vue?vue&type=style&index=0&id=2a5bc6ac&prod&lang=css&
...
;// CONCATENATED MODULE: ./src/components/CustomChat.vue
...
var component = normalizeComponent(
  components_CustomChatvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var CustomChat = (component.exports);
...
;// CONCATENATED MODULE: ./node_modules/vuetify/dist/vuetify.min.css
// extracted by mini-css-extract-plugin
...
/******/ })()
;
//# sourceMappingURL=softchat.common.js.map